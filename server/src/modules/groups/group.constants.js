...
export const GROUP_MESSAGES = Object.freeze({
  ...
  PRIVATE_GROUP: "Ce groupe est privé et ne peut pas être rejoint directement.",
  NOT_MEMBER: "Vous n'êtes pas membre de ce groupe.",
  FORBIDDEN: "Vous n'êtes pas autorisé à effectuer cette action.",
  OWNER_CANNOT_LEAVE: "Le propriétaire ne peut pas quitter le groupe sans transférer la propriété.",
  OWNER_CANNOT_BE_REMOVED: "Le propriétaire du groupe ne peut pas être retiré.",
  OWNER_ROLE_IMMUTABLE: "Le rôle du propriétaire ne peut pas être modifié.",
  CANNOT_PROMOTE_OWNER: "Le rôle OWNER ne peut pas être attribué avec cette opération.",
});
