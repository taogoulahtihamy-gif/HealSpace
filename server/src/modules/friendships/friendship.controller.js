...
export const listIncomingRequests = asyncHandler(async (req, res) => {
  const result = await friendshipService.listIncomingRequests(
    req.user.id,
    req.query,
  );
...
export const listOutgoingRequests = asyncHandler(async (req, res) => {
  const result = await friendshipService.listOutgoingRequests(
    req.user.id,
    req.query,
  );
...
export const removeFriendship = asyncHandler(async (req, res) => {
